...
\markup {
    \column {
        \fill-line{
            \large { \smallCaps "Introduction" }
        }
        \vspace #0.5
        \wordwrap {
            \italic {Shipping Containers} is an experimental art album
        ...
        \vspace #1.0
        \fill-line{
            \smallCaps "Special Note for Educators"
        }
        \vspace #0.8
        \wordwrap {
            The Creative Commons Attribution license means you can use
            this material as you like, \italic {including covering the
            entire album and selling the results to benefit your school.}
        ...
        \vspace #1.0
        \wordwrap {
            \italic {We want to help you use our music.}
            While it may use traditional
        ...
        \vspace #1.0 
        \fill-line {
              \with-url #"https://github.com/mrbeany/shipping-containers" {
